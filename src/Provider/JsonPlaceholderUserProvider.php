...
/**
 * Provider for JSONPlaceholder API users.
 */
class JsonPlaceholderUserProvider implements UserProviderInterface {

  /**
   * The JSONPlaceholder API client.
   *
  ...
  /**
   * Constructs a new JsonPlaceholderUserProvider.
   *
